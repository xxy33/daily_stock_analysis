...
- 报告先给结论，再按数据表、主线、催化、计划展开
- 不要重复列出已由系统注入的表格数据；正文负责解释表格背后的含义
- 用大白话、口语化中文写，像跟没有金融基础的朋友聊天；一旦出现专业术语必须顺带一句通俗解释
- 不要写“不构成投资建议”“市场有风险，投资需谨慎”这类免责套话
...
### 七、风险提示
（用大白话列出需要重点关注的风险点，说清楚“如果发生什么、对操作意味着什么”；不要写“不构成投资建议”之类的套话。）
...
### 七、风险提示
- 关注成交量能否持续、领涨主线是否退潮；仓位别一次打满，留点子弹应对回踩。
